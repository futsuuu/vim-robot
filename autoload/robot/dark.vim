...
hi! SignColumn guifg=#3a414f ctermfg=238 guibg=NONE ctermbg=NONE guisp=NONE gui=NONE cterm=NONE
hi! Whitespace guifg=#3a414f ctermfg=238 guibg=NONE ctermbg=NONE guisp=NONE gui=NONE cterm=NONE
hi! SpecialKey guifg=#6c7588 ctermfg=243 guibg=NONE ctermbg=NONE guisp=NONE gui=NONE cterm=NONE
...
hi! Added guifg=#659149 ctermfg=65 guibg=NONE ctermbg=NONE guisp=NONE gui=NONE cterm=NONE
hi! Removed guifg=#bc6466 ctermfg=131 guibg=NONE ctermbg=NONE guisp=NONE gui=NONE cterm=NONE
hi! Changed guifg=#4685c8 ctermfg=68 guibg=NONE ctermbg=NONE guisp=NONE gui=NONE cterm=NONE
...
hi! DiffText guifg=NONE ctermfg=NONE guibg=#304969 ctermbg=238 guisp=NONE gui=NONE cterm=NONE
...
let g:terminal_ansi_colors = ['#202632', '#ef7675', '#7db349', '#cd9600', '#50a5fa', '#a68cf4', '#00bcc0', '#afbbd3', '#202632', '#ef7675', '#7db349', '#cd9600', '#50a5fa', '#a68cf4', '#00bcc0', '#afbbd3']
endf
